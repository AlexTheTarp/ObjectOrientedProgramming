...
class Program
{
    static void Main(string[] args)
    {
        ...
        employees[0] = new Employee("Matti Meikäläinen", "E001", "Software Developer", 4200.50);
        employees[1] = new Employee("Anna Virtanen", "E002", "Project Manager", 5200.00);
        employees[2] = new Employee("Pekka Korhonen", "E003", "Junior Developer", 3800.75);
